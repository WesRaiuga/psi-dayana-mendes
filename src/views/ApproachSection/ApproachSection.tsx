...
const ApproachSection = () => {
  return (
    <section id='approach'>
      ...
      <p>Na terapia, não buscamos apenas compreender o que dói, mas repensar as narrativas que te acompanham e, quando necessário, construir outros sentidos para o que você vive. Aqui, não existe resposta pronta ou caminho único. Existe presença, escuta, profundidade e o convite para que você possa se reconectar com sua história sem as amarras de rótulos ou padrões que não te representam.</p>
      <p>Meu trabalho não é ocupar o lugar de protagonista da sua vida, mas caminhar ao teu lado como parceira de cuidado e reflexão. <b>Você segue sendo autora da sua trajetória</b>, e juntas podemos revisitar enredos, reconstruir sentidos e fortalecer as escolhas que te aproximam da vida que deseja criar.</p>
    </section>
  )
}
